  ...
  return (
    <section className="relative overflow-hidden pt-28 text-white">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-navy-950/80 via-navy-900/75 to-pearl" />
      </div>
      <div className="relative mx-auto max-w-7xl px-5 pb-20 pt-16 md:px-8 md:pb-24 md:pt-20">
        <p className="text-xs uppercase tracking-[0.24em] text-silver-300">{eyebrow}</p>
        <h1 className="font-display mt-4 max-w-3xl text-5xl leading-tight md:text-6xl">
          {title}
        </h1>
